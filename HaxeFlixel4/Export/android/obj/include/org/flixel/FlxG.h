...
class FlxG_obj : public hx::Object{
	...
	public:
		...
		static ::Hash _soundCache; /* REM */ 
		static ::native::media::SoundTransform _soundTransform; /* REM */ 
		static ::native::media::Sound addSound( ::String EmbeddedSound);
		static Dynamic addSound_dyn();

		static ::org::flixel::FlxSound play( ::String EmbeddedSound,hx::Null< Float >  Volume,hx::Null< bool >  Looped,hx::Null< bool >  AutoDestroy);
