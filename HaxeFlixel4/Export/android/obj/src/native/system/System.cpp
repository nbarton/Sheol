...
{
		HX_STACK_PUSH("System::exit","native/system/System.hx",16);
...
Void System_obj::gc( ){
{
		HX_STACK_PUSH("System::gc","native/system/System.hx",23);
		HX_STACK_LINE(23)
...
::String System_obj::get_deviceID( ){
	HX_STACK_PUSH("System::get_deviceID","native/system/System.hx",45);
	HX_STACK_LINE(45)
	return ::native::system::System_obj::nme_get_unique_device_identifier();
}
...
int System_obj::get_totalMemory( ){
	HX_STACK_PUSH("System::get_totalMemory","native/system/System.hx",48);
	HX_STACK_LINE(48)
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("native.system.System"), hx::TCanCast< System_obj> ,sStaticFields,sMemberFields,
...
{
	nme_get_unique_device_identifier= ::native::Loader_obj::load(HX_CSTRING("nme_get_unique_device_identifier"),(int)0);
}
