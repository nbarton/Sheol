...
{
HX_STACK_PUSH("File::new","native/filesystem/File.hx",32);
{
	HX_STACK_LINE(34)
	this->set_url(path);
	HX_STACK_LINE(35)
...
::String File_obj::set_url( ::String inPath){
	HX_STACK_PUSH("File::set_url","native/filesystem/File.hx",62);
	HX_STACK_THIS(this);
...
::String File_obj::set_nativePath( ::String inPath){
	HX_STACK_PUSH("File::set_nativePath","native/filesystem/File.hx",54);
	HX_STACK_THIS(this);
	HX_STACK_ARG(inPath,"inPath");
	HX_STACK_LINE(56)
...
::native::filesystem::File File_obj::get_applicationDirectory( ){
	HX_STACK_PUSH("File::get_applicationDirectory","native/filesystem/File.hx",47);
	HX_STACK_LINE(47)
...
::native::filesystem::File File_obj::get_applicationStorageDirectory( ){
	HX_STACK_PUSH("File::get_applicationStorageDirectory","native/filesystem/File.hx",48);
	HX_STACK_LINE(48)
...
::native::filesystem::File File_obj::get_desktopDirectory( ){
	HX_STACK_PUSH("File::get_desktopDirectory","native/filesystem/File.hx",49);
	HX_STACK_LINE(49)
...
::native::filesystem::File File_obj::get_documentsDirectory( ){
	HX_STACK_PUSH("File::get_documentsDirectory","native/filesystem/File.hx",50);
	HX_STACK_LINE(50)
...
::native::filesystem::File File_obj::get_userDirectory( ){
	HX_STACK_PUSH("File::get_userDirectory","native/filesystem/File.hx",51);
	HX_STACK_LINE(51)
...
::String File_obj::nme_filesystem_get_special_dir( int inWhich){
	HX_STACK_PUSH("File::nme_filesystem_get_special_dir","native/filesystem/File.hx",108);
	HX_STACK_ARG(inWhich,"inWhich");
	HX_STACK_LINE(110)
	if (((::native::filesystem::File_obj::jni_filesystem_get_special_dir == null()))){
		HX_STACK_LINE(111)
		::native::filesystem::File_obj::jni_filesystem_get_special_dir = ::native::JNI_obj::createStaticMethod(HX_CSTRING("org.haxe.nme.GameActivity"),HX_CSTRING("getSpecialDir"),HX_CSTRING("(I)Ljava/lang/String;"),null());
	}
	HX_STACK_LINE(113)
	return ::native::filesystem::File_obj::jni_filesystem_get_special_dir(inWhich);
}
