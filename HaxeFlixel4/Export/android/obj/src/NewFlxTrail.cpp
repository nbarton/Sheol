...
Void NewFlxTrail_obj::__construct(::org::flixel::FlxSprite Sprite,Dynamic Image,hx::Null< int >  __o_Length,hx::Null< int >  __o_Delay,hx::Null< Float >  __o_Alpha,hx::Null< Float >  __o_Diff)
{
HX_STACK_PUSH("NewFlxTrail::new","NewFlxTrail.hx",15);
...
NewFlxTrail_obj::~NewFlxTrail_obj() { }

Dynamic NewFlxTrail_obj::__CreateEmpty() { return  new NewFlxTrail_obj; }
hx::ObjectPtr< NewFlxTrail_obj > NewFlxTrail_obj::__new(::org::flixel::FlxSprite Sprite,Dynamic Image,hx::Null< int >  __o_Length,hx::Null< int >  __o_Delay,hx::Null< Float >  __o_Alpha,hx::Null< Float >  __o_Diff)
{  hx::ObjectPtr< NewFlxTrail_obj > result = new NewFlxTrail_obj();
	result->__construct(Sprite,Image,__o_Length,__o_Delay,__o_Alpha,__o_Diff);
	return result;}

Dynamic NewFlxTrail_obj::__Create(hx::DynamicArray inArgs)
{  hx::ObjectPtr< NewFlxTrail_obj > result = new NewFlxTrail_obj();
	result->__construct(inArgs[0],inArgs[1],inArgs[2],inArgs[3],inArgs[4],inArgs[5]);
	return result;}

Void NewFlxTrail_obj::changeValuesEnabled( bool Angle,hx::Null< bool >  __o_X,hx::Null< bool >  __o_Y){
bool X = __o_X.Default(true);
bool Y = __o_Y.Default(true);
	HX_STACK_PUSH("NewFlxTrail::changeValuesEnabled","NewFlxTrail.hx",211);
	HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC3(NewFlxTrail_obj,changeValuesEnabled,(void))

Void NewFlxTrail_obj::changeGraphic( Dynamic Image){
{
		HX_STACK_PUSH("NewFlxTrail::changeGraphic","NewFlxTrail.hx",194);
		HX_STACK_THIS(this);
...
HX_DEFINE_DYNAMIC_FUNC1(NewFlxTrail_obj,changeGraphic,(void))

Void NewFlxTrail_obj::decreaseLength( int amount){
{
		HX_STACK_PUSH("NewFlxTrail::decreaseLength","NewFlxTrail.hx",172);
		HX_STACK_THIS(this);
		...
		HX_STACK_LINE(178)
		{
			...
			while(((_g1 < _g))){
				...
				int i = (_g1)++;		HX_STACK_VAR(i,"i");
				HX_STACK_LINE(180)
				if (((i > (this->trailLength - amount)))){
					HX_STACK_LINE(181)
					this->members->__get(i)->kill();
					HX_STACK_LINE(182)
					(this->trailLength)--;
				}
			}
...
HX_DEFINE_DYNAMIC_FUNC1(NewFlxTrail_obj,decreaseLength,(void))

Void NewFlxTrail_obj::increaseLength( int amount){
{
		HX_STACK_PUSH("NewFlxTrail::increaseLength","NewFlxTrail.hx",152);
		HX_STACK_THIS(this);
		HX_STACK_ARG(amount,"amount");
		HX_STACK_LINE(154)
		if (((amount <= (int)0))){
...
HX_DEFINE_DYNAMIC_FUNC1(NewFlxTrail_obj,increaseLength,(void))

Void NewFlxTrail_obj::resetTrail( ){
{
		HX_STACK_PUSH("NewFlxTrail::resetTrail","NewFlxTrail.hx",140);
		HX_STACK_THIS(this);
		HX_STACK_LINE(141)
...
HX_DEFINE_DYNAMIC_FUNC0(NewFlxTrail_obj,resetTrail,(void))

Void NewFlxTrail_obj::postUpdate( ){
{
		HX_STACK_PUSH("NewFlxTrail::postUpdate","NewFlxTrail.hx",99);
		HX_STACK_THIS(this);
		HX_STACK_LINE(101)
		(this->counter)++;
		HX_STACK_LINE(104)
		if (((bool((this->counter >= this->delay)) && bool((this->trailLength >= (int)1))))){
			...
			this->counter = (int)0;
			HX_STACK_LINE(109)
			::org::flixel::FlxPoint spritePosition = ::org::flixel::FlxPoint_obj::__new(this->sprite->x,this->sprite->y);		HX_STACK_VAR(spritePosition,"spritePosition");
			HX_STACK_LINE(110)
...
void NewFlxTrail_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(NewFlxTrail);
...
void NewFlxTrail_obj::__Visit(HX_VISIT_PARAMS)
{
...
Dynamic NewFlxTrail_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"decreaseLength") ) { return decreaseLength_dyn(); }
...
Dynamic NewFlxTrail_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 5:
...
void NewFlxTrail_obj::__GetFields(Array< ::String> &outFields)
{
...
static void sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(NewFlxTrail_obj::__mClass,"__mClass");
};

static void sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(NewFlxTrail_obj::__mClass,"__mClass");
};

Class NewFlxTrail_obj::__mClass;

void NewFlxTrail_obj::__register()
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("NewFlxTrail"), hx::TCanCast< NewFlxTrail_obj> ,sStaticFields,sMemberFields,
	&__CreateEmpty, &__Create,
	&super::__SGetClass(), 0, sMarkStatics, sVisitStatics);
}

void NewFlxTrail_obj::__boot()
{
}
