...
::Hash FlxG_obj::_soundCache;

::native::media::SoundTransform FlxG_obj::_soundTransform;

::native::media::Sound FlxG_obj::addSound( ::String EmbeddedSound){
	HX_STACK_PUSH("FlxG::addSound","org/flixel/FlxG.hx",697);
	HX_STACK_ARG(EmbeddedSound,"EmbeddedSound");
	HX_STACK_LINE(697)
	if ((::org::flixel::FlxG_obj::_soundCache->exists(EmbeddedSound))){
		HX_STACK_LINE(699)
		return ::org::flixel::FlxG_obj::_soundCache->get(EmbeddedSound);
	}
	else{
		HX_STACK_LINE(704)
		::native::media::Sound sound = ::nme::installer::Assets_obj::getSound(EmbeddedSound);		HX_STACK_VAR(sound,"sound");
		HX_STACK_LINE(705)
		::org::flixel::FlxG_obj::_soundCache->set(EmbeddedSound,sound);
		HX_STACK_LINE(706)
		return sound;
	}
	HX_STACK_LINE(697)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxG_obj,addSound,return )

::org::flixel::FlxSound FlxG_obj::play( ::String EmbeddedSound,hx::Null< Float >  __o_Volume,hx::Null< bool >  __o_Looped,hx::Null< bool >  __o_AutoDestroy){
Float Volume = __o_Volume.Default(1.0);
bool Looped = __o_Looped.Default(false);
bool AutoDestroy = __o_AutoDestroy.Default(true);
	HX_STACK_PUSH("FlxG::play","org/flixel/FlxG.hx",711);
	HX_STACK_ARG(EmbeddedSound,"EmbeddedSound");
	HX_STACK_ARG(Volume,"Volume");
	HX_STACK_ARG(Looped,"Looped");
	HX_STACK_ARG(AutoDestroy,"AutoDestroy");
{
		HX_STACK_LINE(712)
		::native::media::Sound sound = null();		HX_STACK_VAR(sound,"sound");
		HX_STACK_LINE(714)
		::org::flixel::FlxG_obj::_soundTransform->volume = ((((  ((::org::flixel::FlxG_obj::mute)) ? int((int)0) : int((int)1) )) * ::org::flixel::FlxG_obj::volume) * Volume);
		HX_STACK_LINE(715)
		::org::flixel::FlxG_obj::_soundTransform->pan = (int)0;
		HX_STACK_LINE(717)
		if ((::org::flixel::FlxG_obj::_soundCache->exists(EmbeddedSound))){
			HX_STACK_LINE(718)
			::org::flixel::FlxG_obj::_soundCache->get(EmbeddedSound)->__Field(HX_CSTRING("play"),true)((int)0,(int)0,::org::flixel::FlxG_obj::_soundTransform);
		}
		else{
			HX_STACK_LINE(723)
			sound = ::nme::installer::Assets_obj::getSound(EmbeddedSound);
			HX_STACK_LINE(725)
			::org::flixel::FlxG_obj::_soundCache->set(EmbeddedSound,sound);
			HX_STACK_LINE(726)
			sound->play((int)0,(int)0,::org::flixel::FlxG_obj::_soundTransform);
		}
		HX_STACK_LINE(729)
		return null();
	}
...
Dynamic FlxG_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"_soundCache") ) { _soundCache=inValue.Cast< ::Hash >(); return inValue; }
		break;
	case 12:
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(FlxG_obj::_soundCache,"_soundCache");
	HX_MARK_MEMBER_NAME(FlxG_obj::_soundTransform,"_soundTransform");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(FlxG_obj::_soundCache,"_soundCache");
	HX_VISIT_MEMBER_NAME(FlxG_obj::_soundTransform,"_soundTransform");
