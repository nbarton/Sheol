...
Void FlxAssets_obj::cacheSounds( ){
{
		...
		HX_STACK_LINE(119)
		::Reflect_obj::callMethod(hx::ClassOf< ::nme::installer::Assets >(),HX_CSTRING("initialize"),Dynamic( Array_obj<Dynamic>::__new()));
		struct _Function_1_1{
			inline static Dynamic Block( ){
				HX_STACK_PUSH("*::closure","org/flixel/FlxAssets.hx",121);
				{
					HX_STACK_LINE(121)
					Dynamic o = hx::ClassOf< ::nme::installer::Assets >();		HX_STACK_VAR(o,"o");
					HX_STACK_LINE(121)
					return (  (((o == null()))) ? Dynamic(null()) : Dynamic(o->__Field(HX_CSTRING("resourceClasses"),true)) );
				}
				return null();
			}
		};
		HX_STACK_LINE(121)
		::Hash resourceClasses = _Function_1_1::Block();		HX_STACK_VAR(resourceClasses,"resourceClasses");
		struct _Function_1_2{
			inline static Dynamic Block( ){
				HX_STACK_PUSH("*::closure","org/flixel/FlxAssets.hx",122);
				{
					HX_STACK_LINE(122)
					Dynamic o = hx::ClassOf< ::nme::installer::Assets >();		HX_STACK_VAR(o,"o");
					HX_STACK_LINE(122)
		...
		HX_STACK_LINE(122)
		::Hash resourceTypes = _Function_1_2::Block();		HX_STACK_VAR(resourceTypes,"resourceTypes");
		HX_STACK_LINE(124)
		if (((resourceTypes != null()))){
			HX_STACK_LINE(125)
			for(::cpp::FastIterator_obj< ::String > *__it = ::cpp::CreateFastIterator< ::String >(resourceTypes->keys());  __it->hasNext(); ){
				::String key = __it->next();
				if (((bool((resourceTypes != null())) && bool((resourceTypes->get(key) == HX_CSTRING("sound")))))){
					HX_STACK_LINE(129)
					::org::flixel::FlxG_obj::addSound(key);
				}
;
			}
		}
