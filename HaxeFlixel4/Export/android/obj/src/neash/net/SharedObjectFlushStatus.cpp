...
::neash::net::SharedObjectFlushStatus SharedObjectFlushStatus_obj::FLUSHED;

::neash::net::SharedObjectFlushStatus SharedObjectFlushStatus_obj::PENDING;
...
Static(__mClass) = hx::RegisterClass(HX_CSTRING("neash.net.SharedObjectFlushStatus"), hx::TCanCast< SharedObjectFlushStatus_obj >,sStaticFields,sMemberFields,
