			...
			HX_STACK_ARG(inFrameHandle,"inFrameHandle");
			{
				...
				try{
				...
				catch(Dynamic __e){
					{
						Dynamic e = __e;{
							HX_STACK_LINE(76)
							::haxe::Log_obj::trace((HX_CSTRING("ERROR: ") + ::Std_obj::string(e)),hx::SourceInfo(HX_CSTRING("Lib.hx"),76,HX_CSTRING("neash.Lib"),HX_CSTRING("create")));
						}
					}
				}
			}
...
void Lib_obj::__boot()
{
	...
	nmeStage= null();
	sIsInit= false;
	nme_post_ui_callback= ::neash::Loader_obj::load(HX_CSTRING("nme_post_ui_callback"),(int)1);
