...
::org::flixel::plugin::photonstorm::FlxVelocity_obj::__register();
::org::flixel::plugin::photonstorm::FlxMath_obj::__register();
::org::flixel::plugin::photonstorm::FlxColor_obj::__register();
::org::flixel::plugin::photonstorm::FlxCollision_obj::__register();
...
::org::flixel::FlxTileblock_obj::__register();
...
::native::JNIMethod_obj::__register();
::native::JNI_obj::__register();
...
::Std_obj::__register();
::Stardust_obj::__register();
::Reflect_obj::__register();
::Player_obj::__register();
::NewFlxTrail_obj::__register();
::List_obj::__register();
...
::native::JNI_obj::__boot();
::native::JNIMethod_obj::__boot();
...
::org::flixel::FlxTileblock_obj::__boot();
...
::org::flixel::plugin::photonstorm::FlxCollision_obj::__boot();
::org::flixel::plugin::photonstorm::FlxColor_obj::__boot();
::org::flixel::plugin::photonstorm::FlxMath_obj::__boot();
::org::flixel::plugin::photonstorm::FlxVelocity_obj::__boot();
