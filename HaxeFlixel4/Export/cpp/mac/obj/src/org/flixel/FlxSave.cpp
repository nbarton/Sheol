	...
	HX_STACK_ARG(OnComplete,"OnComplete");
{
		...
		HX_STACK_LINE(123)
		::neash::net::SharedObjectFlushStatus result;		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(125)
		try{
			HX_STACK_LINE(126)
			result = this->_sharedObject->flush((  (((MinFileSize < (int)0))) ? int(-(MinFileSize)) : int(MinFileSize) ));
		}
		catch(Dynamic __e){
			if (__e.IsClass< ::neash::errors::Error >() ){
				::neash::errors::Error e = __e;{
					HX_STACK_LINE(133)
		...
		HX_STACK_LINE(137)
		if (((result == ::neash::net::SharedObjectFlushStatus_obj::PENDING_dyn()))){
		}
		HX_STACK_LINE(147)
		return this->onDone((  (((result == ::neash::net::SharedObjectFlushStatus_obj::FLUSHED_dyn()))) ? int(::org::flixel::FlxSave_obj::SUCCESS) : int(::org::flixel::FlxSave_obj::PENDING) ));
	}
}
	...
	HX_STACK_ARG(OnComplete,"OnComplete");
{
		...
		HX_STACK_LINE(104)
		return this->flush((  (((MinFileSize < (int)0))) ? int(-(MinFileSize)) : int(MinFileSize) ),OnComplete);
	}
}
...
bool FlxSave_obj::bind( ::String Name){
	...
	try{
		HX_STACK_LINE(80)
		this->_sharedObject = ::neash::net::SharedObject_obj::getLocal(this->name,null(),null());
	}
	catch(Dynamic __e){
		if (__e.IsClass< ::neash::errors::Error >() ){
			::neash::errors::Error e = __e;{
...
Dynamic FlxSave_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 11:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"_sharedObject") ) { _sharedObject=inValue.Cast< ::neash::net::SharedObject >(); return inValue; }
		break;
	case 15:
