...
HX_STACK_PUSH("FlxDebugger::new","org/flixel/system/FlxDebugger.hx",72);
{
	...
	super::__construct();
	HX_STACK_LINE(74)
	this->nmeSetVisible(false);
	HX_STACK_LINE(75)
	this->hasMouse = false;
	HX_STACK_LINE(76)
	this->_screen = ::neash::geom::Point_obj::__new(Width,Height);
	HX_STACK_LINE(81)
	::neash::display::Sprite bg = ::neash::display::Sprite_obj::__new();		HX_STACK_VAR(bg,"bg");
	HX_STACK_LINE(82)
	bg->nmeGetGraphics()->beginFill((int)0,(Float((int)127) / Float((int)255)));
	HX_STACK_LINE(83)
	bg->nmeGetGraphics()->drawRect((int)0,(int)0,::Math_obj::floor(Width),(int)15);
	HX_STACK_LINE(84)
	bg->nmeGetGraphics()->endFill();
	HX_STACK_LINE(85)
	this->addChild(bg);
	HX_STACK_LINE(88)
	::neash::text::TextField txt = ::neash::text::TextField_obj::__new();		HX_STACK_VAR(txt,"txt");
	HX_STACK_LINE(89)
	txt->nmeSetX((int)2);
	HX_STACK_LINE(90)
	txt->nmeSetWidth((int)160);
	HX_STACK_LINE(91)
	txt->nmeSetHeight((int)16);
	HX_STACK_LINE(92)
	txt->nmeSetSelectable(false);
	HX_STACK_LINE(93)
	txt->nmeSetMultiline(false);
	HX_STACK_LINE(94)
	txt->nmeSetDefaultTextFormat(::neash::text::TextFormat_obj::__new(::org::flixel::FlxAssets_obj::getCourierFont(),(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
	HX_STACK_LINE(95)
	...
	this->_gutter = (int)8;
	HX_STACK_LINE(108)
	::neash::geom::Rectangle screenBounds = ::neash::geom::Rectangle_obj::__new(this->_gutter,((int)15 + (Float(this->_gutter) / Float((int)2))),(this->_screen->x - (this->_gutter * (int)2)),((this->_screen->y - (this->_gutter * 1.5)) - (int)15));		HX_STACK_VAR(screenBounds,"screenBounds");
	HX_STACK_LINE(110)
	...
	HX_STACK_LINE(120)
	this->vcr->nmeSetX((Float(((Width - (Float(this->vcr->nmeGetWidth()) / Float((int)2))))) / Float((int)2)));
	HX_STACK_LINE(121)
	this->vcr->nmeSetY((int)2);
	HX_STACK_LINE(122)
	this->addChild(this->vcr);
	HX_STACK_LINE(124)
	this->vis = ::org::flixel::system::debug::Vis_obj::__new();
	HX_STACK_LINE(125)
	this->vis->nmeSetX(((Width - this->vis->nmeGetWidth()) - (int)4));
	HX_STACK_LINE(126)
	this->vis->nmeSetY((int)2);
	HX_STACK_LINE(127)
	this->addChild(this->vis);
	HX_STACK_LINE(129)
	this->setLayout((int)0);
	HX_STACK_LINE(132)
	this->addEventListener(::neash::events::MouseEvent_obj::MOUSE_OVER,this->onMouseOver_dyn(),null(),null(),null());
	HX_STACK_LINE(133)
	this->addEventListener(::neash::events::MouseEvent_obj::MOUSE_OUT,this->onMouseOut_dyn(),null(),null(),null());
}
;
	return null();
}
...
Void FlxDebugger_obj::onMouseOut( ::neash::events::MouseEvent E){
{
...
Void FlxDebugger_obj::onMouseOver( ::neash::events::MouseEvent E){
{
...
Void FlxDebugger_obj::destroy( ){
{
		...
		this->vis = null();
		HX_STACK_LINE(158)
		this->removeEventListener(::neash::events::MouseEvent_obj::MOUSE_OVER,this->onMouseOver_dyn(),null());
		HX_STACK_LINE(159)
		this->removeEventListener(::neash::events::MouseEvent_obj::MOUSE_OUT,this->onMouseOut_dyn(),null());
	}
return null();
}
...
Dynamic FlxDebugger_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"_screen") ) { _screen=inValue.Cast< ::neash::geom::Point >(); return inValue; }
