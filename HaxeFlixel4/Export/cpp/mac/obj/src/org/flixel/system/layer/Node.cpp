...
Void Node_obj::__construct(::org::flixel::system::layer::Atlas atlas,::neash::geom::Rectangle rect,::neash::display::BitmapData item,::String __o_key)
{
...
::String key = __o_key.Default(HX_CSTRING(""));
{
	...
	this->rect = rect;
	HX_STACK_LINE(32)
	this->point = ::neash::geom::Point_obj::__new(rect->x,rect->y);
	HX_STACK_LINE(33)
	this->key = key;
}
;
...
hx::ObjectPtr< Node_obj > Node_obj::__new(::org::flixel::system::layer::Atlas atlas,::neash::geom::Rectangle rect,::neash::display::BitmapData item,::String __o_key)
...
int Node_obj::addTileRect( ::neash::geom::Rectangle tileRect,::neash::geom::Point point){
...
::org::flixel::system::layer::FlxSpriteFrames Node_obj::addSpriteFramesData( int frameWidth,int frameHeight,::neash::geom::Point origin,hx::Null< int >  __o_startX,hx::Null< int >  __o_startY,hx::Null< int >  __o_endX,hx::Null< int >  __o_endY,hx::Null< int >  __o_xSpacing,hx::Null< int >  __o_ySpacing){
	...
	HX_STACK_ARG(ySpacing,"ySpacing");
{
		...
		if (((endX == (int)0))){
			HX_STACK_LINE(77)
			hx::AddEq(endX,this->item->nmeGetWidth());
		}
		HX_STACK_LINE(80)
		if (((endY == (int)0))){
			HX_STACK_LINE(81)
			hx::AddEq(endY,this->item->nmeGetHeight());
		}
		HX_STACK_LINE(84)
...
Dynamic Node_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 4:
		...
		if (HX_FIELD_EQ(inName,"item") ) { item=inValue.Cast< ::neash::display::BitmapData >(); return inValue; }
		break;
	case 5:
