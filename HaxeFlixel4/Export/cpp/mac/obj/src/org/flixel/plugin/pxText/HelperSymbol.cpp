...
{
HX_STACK_PUSH("HelperSymbol::new","org/flixel/plugin/pxText/PxBitmapFont.hx",793);
{
}
;
	return null();
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("org.flixel.plugin.pxText.HelperSymbol"), hx::TCanCast< HelperSymbol_obj> ,sStaticFields,sMemberFields,
