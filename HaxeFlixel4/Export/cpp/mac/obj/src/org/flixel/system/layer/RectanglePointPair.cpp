...
Void RectanglePointPair_obj::__construct(::neash::geom::Rectangle rect,::neash::geom::Point point)
{
HX_STACK_PUSH("RectanglePointPair::new","org/flixel/system/layer/TileSheetData.hx",341);
{
	HX_STACK_LINE(342)
	this->rect = rect;
	HX_STACK_LINE(343)
...
hx::ObjectPtr< RectanglePointPair_obj > RectanglePointPair_obj::__new(::neash::geom::Rectangle rect,::neash::geom::Point point)
...
{
		HX_STACK_PUSH("RectanglePointPair::destroy","org/flixel/system/layer/TileSheetData.hx",347);
		HX_STACK_THIS(this);
		HX_STACK_LINE(348)
		this->rect = null();
		HX_STACK_LINE(349)
