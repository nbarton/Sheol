...
Void Perf_obj::__construct(::String Title,Float Width,Float Height,hx::Null< bool >  __o_Resizable,::neash::geom::Rectangle Bounds,Dynamic BGColor,Dynamic TopColor)
{
...
bool Resizable = __o_Resizable.Default(true);
{
	...
	HX_STACK_LINE(84)
	this->_text->nmeSetWidth(this->_width);
	HX_STACK_LINE(85)
...
hx::ObjectPtr< Perf_obj > Perf_obj::__new(::String Title,Float Width,Float Height,hx::Null< bool >  __o_Resizable,::neash::geom::Rectangle Bounds,Dynamic BGColor,Dynamic TopColor)
...
Void Perf_obj::update( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(141)
		int time = ::neash::Lib_obj::getTimer();		HX_STACK_VAR(time,"time");
		HX_STACK_LINE(142)
		...
		if (((this->_updateTimer > updateEvery))){
			...
			HX_STACK_LINE(165)
			hx::AddEq(output,((Float(::Math_obj::round(((::neash::system::System_obj::nmeGetTotalMemory() * 0.000000954) * (int)100))) / Float((int)100)) + HX_CSTRING("MB\n")));
			HX_STACK_LINE(167)
