...
Float FlxTween_obj::getScale( ){
	HX_STACK_PUSH("FlxTween::getScale","org/flixel/tweens/FlxTween.hx",172);
	HX_STACK_THIS(this);
	HX_STACK_LINE(172)
	return this->_t;
}
...
Float FlxTween_obj::setPercent( Float value){
	HX_STACK_PUSH("FlxTween::setPercent","org/flixel/tweens/FlxTween.hx",169);
	HX_STACK_THIS(this);
...
Float FlxTween_obj::getPercent( ){
	HX_STACK_PUSH("FlxTween::getPercent","org/flixel/tweens/FlxTween.hx",168);
	HX_STACK_THIS(this);
	HX_STACK_LINE(168)
