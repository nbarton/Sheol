...
::String FlxAssets_obj::getNokiaFont( ){
	HX_STACK_PUSH("FlxAssets::getNokiaFont","org/flixel/FlxAssets.hx",48);
	HX_STACK_LINE(48)
	return ::nme::installer::Assets_obj::getFont(HX_CSTRING("assets/data/nokiafc22.ttf"))->fontName;
}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxAssets_obj,getNokiaFont,return )

::String FlxAssets_obj::courierFont;

::String FlxAssets_obj::getCourierFont( ){
	HX_STACK_PUSH("FlxAssets::getCourierFont","org/flixel/FlxAssets.hx",54);
	HX_STACK_LINE(54)
	return ::nme::installer::Assets_obj::getFont(HX_CSTRING("assets/data/courier.ttf"))->fontName;
}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxAssets_obj,getCourierFont,return )

::String FlxAssets_obj::sndBeep;

Void FlxAssets_obj::drawLogo( ::neash::display::Graphics graph){
{
		HX_STACK_PUSH("FlxAssets::drawLogo","org/flixel/FlxAssets.hx",61);
...
{
		HX_STACK_PUSH("FlxAssets::cacheSounds","org/flixel/FlxAssets.hx",118);
	}
return null();
}
...
Dynamic FlxAssets_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"nokiaFont") ) { return inCallProp ? getNokiaFont() : nokiaFont; }
		break;
	case 10:
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"courierFont") ) { return inCallProp ? getCourierFont() : courierFont; }
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"getNokiaFont") ) { return getNokiaFont_dyn(); }
		break;
	case 13:
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"getCourierFont") ) { return getCourierFont_dyn(); }
		break;
	case 16:
...
static ::String sStaticFields[] = {
	...
	HX_CSTRING("getNokiaFont"),
	HX_CSTRING("courierFont"),
	HX_CSTRING("getCourierFont"),
	HX_CSTRING("sndBeep"),
	HX_CSTRING("drawLogo"),
