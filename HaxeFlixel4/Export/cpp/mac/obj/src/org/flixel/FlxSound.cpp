...
Void FlxSound_obj::gotID3( ::neash::events::Event event){
{
		...
		HX_STACK_LINE(541)
		this->name = this->_sound->nmeGetID3()->songName;
		HX_STACK_LINE(542)
		this->artist = this->_sound->nmeGetID3()->artist;
		HX_STACK_LINE(543)
		this->_sound->removeEventListener(::neash::events::Event_obj::ID3,this->gotID3_dyn(),null());
	}
return null();
}
	...
	HX_STACK_ARG(resetPosition,"resetPosition");
{
		...
		if (((this->_channel != null()))){
			HX_STACK_LINE(515)
			this->_channel->removeEventListener(::neash::events::Event_obj::SOUND_COMPLETE,this->stopped_dyn(),null());
			HX_STACK_LINE(516)
			this->_channel->stop();
			HX_STACK_LINE(517)
			this->_channel = null();
...
Void FlxSound_obj::stopped( ::neash::events::Event event){
{
...
Void FlxSound_obj::startSound( Float Position){
{
		...
		if (((this->_channel != null()))){
			HX_STACK_LINE(479)
			this->_channel->addEventListener(::neash::events::Event_obj::SOUND_COMPLETE,this->stopped_dyn(),null(),null(),null());
			HX_STACK_LINE(480)
			this->active = true;
		}
		else{
...
Void FlxSound_obj::updateTransform( ){
{
		...
		if (((this->_channel != null()))){
			HX_STACK_LINE(463)
			this->_channel->nmeSetTransform(this->_transform);
		}
	}
return null();
}
...
Void FlxSound_obj::pause( ){
{
		...
		HX_STACK_LINE(385)
		this->_position = this->_channel->nmeGetPosition();
		HX_STACK_LINE(386)
		this->_paused = true;
		HX_STACK_LINE(387)
	...
	HX_STACK_ARG(AutoDestroy,"AutoDestroy");
{
		...
		HX_STACK_LINE(306)
		this->_sound->addEventListener(::neash::events::Event_obj::ID3,this->gotID3_dyn(),null(),null(),null());
		HX_STACK_LINE(307)
		this->_sound->load(::neash::net::URLRequest_obj::__new(SoundURL),null(),null());
		HX_STACK_LINE(308)
		this->_looped = Looped;
		HX_STACK_LINE(309)
	...
	HX_STACK_ARG(AutoDestroy,"AutoDestroy");
{
		...
		this->createSound();
		HX_STACK_LINE(273)
		if ((::Std_obj::is(EmbeddedSound,hx::ClassOf< ::neash::media::Sound >()))){
			HX_STACK_LINE(274)
...
Void FlxSound_obj::update( ){
{
		...
		if (((bool((this->_transform->volume > (int)0)) && bool((this->_channel != null()))))){
			HX_STACK_LINE(250)
			this->amplitudeLeft = (Float(this->_channel->nmeGetLeft()) / Float(this->_transform->volume));
			HX_STACK_LINE(251)
			this->amplitudeRight = (Float(this->_channel->nmeGetRight()) / Float(this->_transform->volume));
			HX_STACK_LINE(252)
...
Void FlxSound_obj::destroy( ){
{
		...
		this->kill();
		HX_STACK_LINE(169)
		if (((bool((this->_sound != null())) && bool(this->_sound->hasEventListener(::neash::events::Event_obj::ID3))))){
			HX_STACK_LINE(170)
			this->_sound->removeEventListener(::neash::events::Event_obj::ID3,this->gotID3_dyn(),null());
		}
		HX_STACK_LINE(174)
...
Void FlxSound_obj::createSound( ){
{
		...
		if (((this->_transform == null()))){
			HX_STACK_LINE(133)
			this->_transform = ::neash::media::SoundTransform_obj::__new(null(),null());
		}
		HX_STACK_LINE(136)
...
Dynamic FlxSound_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"_channel") ) { _channel=inValue.Cast< ::neash::media::SoundChannel >(); return inValue; }
		break;
	case 9:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"_transform") ) { _transform=inValue.Cast< ::neash::media::SoundTransform >(); return inValue; }
		break;
	case 11:
