...
{
HX_STACK_PUSH("FlxSpriteFrames::new","org/flixel/system/layer/TileSheetData.hx",307);
{
	HX_STACK_LINE(308)
	this->width = width;
	HX_STACK_LINE(309)
...
{
		HX_STACK_PUSH("FlxSpriteFrames::destroy","org/flixel/system/layer/TileSheetData.hx",326);
		HX_STACK_THIS(this);
		HX_STACK_LINE(326)
		this->frameIDs = null();
	}
