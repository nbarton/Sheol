...
Void Atlas_obj::__construct(::String name,int width,int height,hx::Null< int >  __o_borderX,hx::Null< int >  __o_borderY,::neash::display::BitmapData bitmapData)
{
...
int borderY = __o_borderY.Default(1);
{
	...
	if (((bitmapData == null()))){
		HX_STACK_LINE(65)
		this->root = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new((int)0,(int)0,width,height),null(),null());
		HX_STACK_LINE(67)
		this->atlasBitmapData = ::neash::display::BitmapData_obj::__new(width,height,true,(int)0,null());
		HX_STACK_LINE(71)
		this->_fromBitmapData = false;
	}
	else{
		HX_STACK_LINE(75)
		this->root = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),bitmapData->nmeGetRect(),bitmapData,name);
		HX_STACK_LINE(76)
...
hx::ObjectPtr< Atlas_obj > Atlas_obj::__new(::String name,int width,int height,hx::Null< int >  __o_borderX,hx::Null< int >  __o_borderY,::neash::display::BitmapData bitmapData)
...
::org::flixel::system::layer::Node Atlas_obj::clearAndFillWith( ::neash::display::BitmapData bmd){
	...
	HX_STACK_LINE(526)
	this->root = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),bmd->nmeGetRect(),bmd,this->name);
	HX_STACK_LINE(527)
...
Void Atlas_obj::clear( ){
{
		...
		this->deleteSubtree(this->root);
		HX_STACK_LINE(502)
		this->root = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new((int)0,(int)0,rootWidth,rootHeight),null(),null());
		HX_STACK_LINE(504)
...
Void Atlas_obj::generateAtlasFromQueue( ){
{
		...
		if (((this->tempStorage != null()))){
			HX_STACK_LINE(462)
			Array< ::neash::display::BitmapData > bitmaps = Array_obj< ::neash::display::BitmapData >::__new();		HX_STACK_VAR(bitmaps,"bitmaps");
			HX_STACK_LINE(463)
...
Void Atlas_obj::addToQueue( ::neash::display::BitmapData data,::String key){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::neash::display::BitmapData &data,::String &key){
...
int Atlas_obj::bitmapSorter( ::neash::display::BitmapData bmd1,::neash::display::BitmapData bmd2){
	HX_STACK_PUSH("Atlas::bitmapSorter","org/flixel/system/layer/Atlas.hx",407);
	HX_STACK_THIS(this);
	HX_STACK_ARG(bmd1,"bmd1");
	HX_STACK_ARG(bmd2,"bmd2");
	HX_STACK_LINE(408)
	if (((bmd2->nmeGetWidth() == bmd1->nmeGetWidth()))){
		HX_STACK_LINE(409)
		if (((bmd2->nmeGetHeight() == bmd1->nmeGetHeight()))){
			HX_STACK_LINE(411)
			return (int)0;
		}
		else{
...
int Atlas_obj::indexOf( Array< ::neash::display::BitmapData > bitmaps,::neash::display::BitmapData bmd){
...
bool Atlas_obj::addNodes( Array< ::neash::display::BitmapData > bitmaps,Array< ::String > keys){
	...
	HX_STACK_LINE(374)
	Array< ::neash::display::BitmapData > sortedBitmaps = bitmaps->slice((int)0,bitmaps->length);		HX_STACK_VAR(sortedBitmaps,"sortedBitmaps");
	HX_STACK_LINE(375)
...
::org::flixel::system::layer::Node Atlas_obj::getNodeByBitmap( ::neash::display::BitmapData bitmap){
...
::org::flixel::system::layer::Node Atlas_obj::addNode( ::neash::display::BitmapData data,::String key){
	...
	HX_STACK_LINE(243)
	if (((this->root->canPlace(data->nmeGetWidth(),data->nmeGetHeight()) == false))){
		HX_STACK_LINE(244)
		return null();
	}
	HX_STACK_LINE(248)
	int insertWidth = (  (((data->nmeGetWidth() == this->get_width()))) ? int(data->nmeGetWidth()) : int((data->nmeGetWidth() + this->borderX)) );		HX_STACK_VAR(insertWidth,"insertWidth");
	HX_STACK_LINE(249)
	int insertHeight = (  (((data->nmeGetHeight() == this->get_height()))) ? int(data->nmeGetHeight()) : int((data->nmeGetHeight() + this->borderY)) );		HX_STACK_VAR(insertHeight,"insertHeight");
	HX_STACK_LINE(251)
	...
	if (((nodeToInsert != null()))){
		...
		if (((dw > dh))){
			HX_STACK_LINE(264)
			firstChild = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new(nodeToInsert->get_x(),nodeToInsert->get_y(),insertWidth,nodeToInsert->get_height()),null(),null());
			HX_STACK_LINE(265)
			secondChild = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new((nodeToInsert->get_x() + insertWidth),nodeToInsert->get_y(),(nodeToInsert->get_width() - insertWidth),nodeToInsert->get_height()),null(),null());
			HX_STACK_LINE(267)
			firstGrandChild = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new(firstChild->get_x(),firstChild->get_y(),insertWidth,insertHeight),data,key);
			HX_STACK_LINE(268)
			secondGrandChild = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new(firstChild->get_x(),(firstChild->get_y() + insertHeight),insertWidth,(firstChild->get_height() - insertHeight)),null(),null());
		}
		else{
			HX_STACK_LINE(272)
			firstChild = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new(nodeToInsert->get_x(),nodeToInsert->get_y(),nodeToInsert->get_width(),insertHeight),null(),null());
			HX_STACK_LINE(273)
			secondChild = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new(nodeToInsert->get_x(),(nodeToInsert->get_y() + insertHeight),nodeToInsert->get_width(),(nodeToInsert->get_height() - insertHeight)),null(),null());
			HX_STACK_LINE(275)
			firstGrandChild = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new(firstChild->get_x(),firstChild->get_y(),insertWidth,insertHeight),data,key);
			HX_STACK_LINE(276)
			secondGrandChild = ::org::flixel::system::layer::Node_obj::__new(hx::ObjectPtr<OBJ_>(this),::neash::geom::Rectangle_obj::__new((firstChild->get_x() + insertWidth),firstChild->get_y(),(firstChild->get_width() - insertWidth),insertHeight),null(),null());
		}
		HX_STACK_LINE(279)
		...
		HX_STACK_LINE(285)
		this->atlasBitmapData->copyPixels(data,data->nmeGetRect(),firstGrandChild->point,null(),null(),null());
		HX_STACK_LINE(287)
...
Void Atlas_obj::resize( int newWidth,int newHeight){
{
		...
		this->atlasBitmapData->dispose();
		HX_STACK_LINE(223)
		this->atlasBitmapData = ::neash::display::BitmapData_obj::__new(newWidth,newHeight,true,(int)0,null());
		HX_STACK_LINE(227)
		this->rebuildAtlas();
	}
return null();
...
Void Atlas_obj::redrawAll( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(203)
		this->atlasBitmapData->fillRect(this->atlasBitmapData->nmeGetRect(),(int)0);
		HX_STACK_LINE(208)
		for(::cpp::FastIterator_obj< ::org::flixel::system::layer::Node > *__it = ::cpp::CreateFastIterator< ::org::flixel::system::layer::Node >(this->nodes->iterator());  __it->hasNext(); ){
			::org::flixel::system::layer::Node node = __it->next();
...
::org::flixel::system::layer::Atlas Atlas_obj::getAtlas( ::String Key,::neash::display::BitmapData BmData,hx::Null< bool >  __o_Unique){
	...
	HX_STACK_ARG(Unique,"Unique");
{
		...
		HX_STACK_LINE(112)
		::org::flixel::system::layer::Atlas atlas = ::org::flixel::system::layer::Atlas_obj::__new(AtlasKey,BmData->nmeGetWidth(),BmData->nmeGetHeight(),(int)1,(int)1,BmData);		HX_STACK_VAR(atlas,"atlas");
		HX_STACK_LINE(113)
		return atlas;
	}
}
...
Dynamic Atlas_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 15:
		...
		if (HX_FIELD_EQ(inName,"atlasBitmapData") ) { atlasBitmapData=inValue.Cast< ::neash::display::BitmapData >(); return inValue; }
	}
