...
::neash::geom::Rectangle FlxRect_obj::copyToFlash( ::neash::geom::Rectangle FlashRect){
...
::org::flixel::FlxRect FlxRect_obj::copyFromFlash( ::neash::geom::Rectangle FlashRect){
