...
HX_STACK_PUSH("WatchEntry::new","org/flixel/system/debug/WatchEntry.hx",59);
{
	...
	this->custom = Custom;
	HX_STACK_LINE(66)
	this->_whiteText = ::neash::text::TextFormat_obj::__new(::org::flixel::FlxAssets_obj::getCourierFont(),(int)12,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(67)
	this->_blackText = ::neash::text::TextFormat_obj::__new(::org::flixel::FlxAssets_obj::getCourierFont(),(int)12,(int)0,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
	HX_STACK_LINE(69)
	this->nameDisplay = ::neash::text::TextField_obj::__new();
	HX_STACK_LINE(70)
	this->nameDisplay->nmeSetY(Y);
	HX_STACK_LINE(71)
	this->nameDisplay->nmeSetMultiline(false);
	HX_STACK_LINE(72)
	this->nameDisplay->nmeSetSelectable(true);
	HX_STACK_LINE(73)
	this->nameDisplay->nmeSetDefaultTextFormat(this->_whiteText);
	HX_STACK_LINE(75)
	this->valueDisplay = ::neash::text::TextField_obj::__new();
	HX_STACK_LINE(76)
	this->valueDisplay->nmeSetY(Y);
	HX_STACK_LINE(77)
	this->valueDisplay->nmeSetHeight((int)15);
	HX_STACK_LINE(78)
	this->valueDisplay->nmeSetMultiline(false);
	HX_STACK_LINE(79)
	this->valueDisplay->nmeSetSelectable(true);
	HX_STACK_LINE(80)
	this->valueDisplay->doubleClickEnabled = true;
	HX_STACK_LINE(81)
	this->valueDisplay->addEventListener(::neash::events::KeyboardEvent_obj::KEY_UP,this->onKeyUp_dyn(),null(),null(),null());
	HX_STACK_LINE(82)
	this->valueDisplay->addEventListener(::neash::events::MouseEvent_obj::MOUSE_UP,this->onMouseUp_dyn(),null(),null(),null());
	HX_STACK_LINE(83)
	this->valueDisplay->nmeSetBackground(false);
	HX_STACK_LINE(84)
	this->valueDisplay->nmeSetBackgroundColor((int)16777215);
	HX_STACK_LINE(85)
	this->valueDisplay->nmeSetDefaultTextFormat(this->_whiteText);
	HX_STACK_LINE(87)
...
Void WatchEntry_obj::doneEditing( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(217)
		this->valueDisplay->nmeSetType(::neash::text::TextFieldType_obj::DYNAMIC_dyn());
		HX_STACK_LINE(218)
...
Void WatchEntry_obj::submit( ){
{
		...
		HX_STACK_LINE(208)
		{
			...
			if (((o != null()))){
				HX_STACK_LINE(208)
				o->__SetField(this->field,this->valueDisplay->nmeGetText(),true);
			}
		}
		HX_STACK_LINE(209)
		this->doneEditing();
...
Void WatchEntry_obj::cancel( ){
{
		...
		HX_STACK_THIS(this);
		HX_STACK_LINE(198)
		this->valueDisplay->nmeSetText(this->oldValue->toString());
		HX_STACK_LINE(199)
		this->doneEditing();
	}
return null();
...
Void WatchEntry_obj::onKeyUp( ::neash::events::KeyboardEvent FlashEvent){
{
...
Void WatchEntry_obj::onMouseUp( ::neash::events::MouseEvent FlashEvent){
{
		...
		HX_STACK_LINE(167)
		this->valueDisplay->nmeSetType(::neash::text::TextFieldType_obj::INPUT_dyn());
		HX_STACK_LINE(168)
		this->valueDisplay->setTextFormat(this->_blackText,null(),null());
		HX_STACK_LINE(169)
		this->valueDisplay->nmeSetBackground(true);
	}
return null();
}
...
bool WatchEntry_obj::updateValue( ){
	...
	HX_STACK_LINE(154)
	this->valueDisplay->nmeSetText(::Std_obj::string(_Function_1_1::Block(this)));
	HX_STACK_LINE(155)
	return true;
}
...
Void WatchEntry_obj::updateWidth( Float NameWidth,Float ValueWidth){
{
		...
		HX_STACK_LINE(119)
		this->nameDisplay->nmeSetWidth(NameWidth);
		HX_STACK_LINE(120)
		this->valueDisplay->nmeSetWidth(ValueWidth);
		HX_STACK_LINE(121)
		if (((this->custom != null()))){
			HX_STACK_LINE(122)
			this->nameDisplay->nmeSetText(this->custom);
		}
		else{
			HX_STACK_LINE(127)
			this->nameDisplay->nmeSetText(HX_CSTRING(""));
			HX_STACK_LINE(128)
			if (((NameWidth > (int)120))){
				...
				HX_STACK_LINE(129)
				this->nameDisplay->nmeSetText(((this->nameDisplay->nmeGetText() + _Function_3_1::Block(this,NameWidth)) + HX_CSTRING(".")));
			}
			HX_STACK_LINE(139)
			this->nameDisplay->nmeSetText((this->nameDisplay->nmeGetText() + this->field));
		}
	}
return null();
}
...
Void WatchEntry_obj::destroy( ){
{
		...
		this->custom = null();
		HX_STACK_LINE(100)
		this->valueDisplay->removeEventListener(::neash::events::MouseEvent_obj::MOUSE_UP,this->onMouseUp_dyn(),null());
		HX_STACK_LINE(101)
		this->valueDisplay->removeEventListener(::neash::events::KeyboardEvent_obj::KEY_UP,this->onKeyUp_dyn(),null());
		HX_STACK_LINE(102)
...
Dynamic WatchEntry_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 8:
		...
		break;
	case 10:
		if (HX_FIELD_EQ(inName,"_blackText") ) { _blackText=inValue.Cast< ::neash::text::TextFormat >(); return inValue; }
		if (HX_FIELD_EQ(inName,"_whiteText") ) { _whiteText=inValue.Cast< ::neash::text::TextFormat >(); return inValue; }
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"nameDisplay") ) { nameDisplay=inValue.Cast< ::neash::text::TextField >(); return inValue; }
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"valueDisplay") ) { valueDisplay=inValue.Cast< ::neash::text::TextField >(); return inValue; }
	}
