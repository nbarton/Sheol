...
class Atlas_obj : public hx::Object{
	public:
		...
		Atlas_obj();
		Void __construct(::String name,int width,int height,hx::Null< int >  __o_borderX,hx::Null< int >  __o_borderY,::neash::display::BitmapData bitmapData);

	public:
		static hx::ObjectPtr< Atlas_obj > __new(::String name,int width,int height,hx::Null< int >  __o_borderX,hx::Null< int >  __o_borderY,::neash::display::BitmapData bitmapData);
		...
		virtual ::org::flixel::system::layer::Node clearAndFillWith( ::neash::display::BitmapData bmd);
		...
		virtual Void addToQueue( ::neash::display::BitmapData data,::String key);
		Dynamic addToQueue_dyn();

		virtual Void createQueue( );
		Dynamic createQueue_dyn();

		virtual int bitmapSorter( ::neash::display::BitmapData bmd1,::neash::display::BitmapData bmd2);
		Dynamic bitmapSorter_dyn();

		virtual int indexOf( Array< ::neash::display::BitmapData > bitmaps,::neash::display::BitmapData bmd);
		Dynamic indexOf_dyn();

		virtual bool addNodes( Array< ::neash::display::BitmapData > bitmaps,Array< ::String > keys);
		Dynamic addNodes_dyn();

		virtual ::org::flixel::system::layer::Node getNodeByBitmap( ::neash::display::BitmapData bitmap);
		...
		int width; /* REM */ 
		virtual ::org::flixel::system::layer::Node addNode( ::neash::display::BitmapData data,::String key);
		Dynamic addNode_dyn();
		...
		int borderY; /* REM */ 
		int borderX; /* REM */ 
		::neash::display::BitmapData atlasBitmapData; /* REM */ 
		::Hash nodes; /* REM */ 
		::String name; /* REM */ 
		::org::flixel::system::layer::Node root; /* REM */ 
		Dynamic tempStorage; /* REM */ 
		static ::Hash _atlasCache; /* REM */ 
		static ::org::flixel::system::layer::Atlas getAtlas( ::String Key,::neash::display::BitmapData BmData,hx::Null< bool >  Unique);
