...
class PxBitmapFont_obj : public hx::Object{
	...
	public:
		...
		virtual ::neash::display::BitmapData get_pixels( );
		Dynamic get_pixels_dyn();

		::neash::display::BitmapData pixels; /* REM */ 
		...
		virtual Void setGlyph( ::org::flixel::system::layer::Node node,int pCharID,::neash::geom::Rectangle pRect,hx::Null< int >  pOffsetX,hx::Null< int >  pOffsetY,hx::Null< int >  pAdvanceX);
		Dynamic setGlyph_dyn();

		virtual Void dispose( hx::Null< bool >  total);
		Dynamic dispose_dyn();

		virtual ::neash::display::BitmapData prepareAngelCodeBitmapData( ::neash::display::BitmapData pBitmapData,::Xml pXMLData,Array< ::org::flixel::plugin::pxText::HelperSymbol > pSymbols);
		Dynamic prepareAngelCodeBitmapData_dyn();

		virtual ::neash::display::BitmapData preparePixelizerBitmapData( ::neash::display::BitmapData pBitmapData,Array< ::neash::geom::Rectangle > pRects);
		...
		virtual ::org::flixel::plugin::pxText::PxBitmapFont loadAngelCode( ::neash::display::BitmapData pBitmapData,::Xml pXMLData);
		Dynamic loadAngelCode_dyn();

		virtual ::org::flixel::plugin::pxText::PxBitmapFont loadPixelizer( ::neash::display::BitmapData pBitmapData,::String pLetters);
		Dynamic loadPixelizer_dyn();

		::String _bitmapDataKey; /* REM */ 
		::neash::display::BitmapData _pixels; /* REM */ 
		Array< ::org::flixel::plugin::pxText::HelperSymbol > _symbols; /* REM */ 
		Array< ::neash::geom::Rectangle > _tileRects; /* REM */ 
		...
		static ::neash::geom::Point ZERO_POINT; /* REM */ 
