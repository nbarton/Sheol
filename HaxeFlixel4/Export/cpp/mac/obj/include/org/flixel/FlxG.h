...
class FlxG_obj : public hx::Object{
	...
	public:
		...
		static ::neash::geom::Rectangle _cameraRect; /* REM */ 
		...
		static ::neash::display::Sprite flashGfxSprite; /* REM */ 
		static ::neash::display::Graphics flashGfx; /* REM */ 
		...
		static ::neash::display::BitmapData createBitmap( int Width,int Height,int Color,hx::Null< bool >  Unique,::String Key);
		static Dynamic createBitmap_dyn();

		static ::neash::display::BitmapData addBitmap( Dynamic Graphic,hx::Null< bool >  Reverse,hx::Null< bool >  Unique,::String Key,hx::Null< int >  FrameWidth,hx::Null< int >  FrameHeight);
		static Dynamic addBitmap_dyn();

		static ::String getCacheKeyFor( ::neash::display::BitmapData bmd);
		static Dynamic getCacheKeyFor_dyn();

		static ::String getUniqueBitmapKey( ::String baseKey);
		static Dynamic getUniqueBitmapKey_dyn();

		static bool fromAssetsCache( ::neash::display::BitmapData bmd);
