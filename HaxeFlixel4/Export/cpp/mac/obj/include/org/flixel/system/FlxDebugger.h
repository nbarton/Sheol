...
class FlxDebugger_obj : public ::neash::display::Sprite_obj{
	public:
	...
	public:
		...
		virtual Void onMouseOut( ::neash::events::MouseEvent E);
		Dynamic onMouseOut_dyn();

		virtual Void onMouseOver( ::neash::events::MouseEvent E);
