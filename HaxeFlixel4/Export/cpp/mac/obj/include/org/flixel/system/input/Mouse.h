...
class Mouse_obj : public ::org::flixel::FlxPoint_obj{
	public:
		...
		Mouse_obj();
		Void __construct(::neash::display::Sprite CursorContainer);

	public:
		static hx::ObjectPtr< Mouse_obj > __new(::neash::display::Sprite CursorContainer);
		...
		virtual Void handleMouseWheel( ::neash::events::MouseEvent FlashEvent);
		Dynamic handleMouseWheel_dyn();

		virtual Void handleMouseUp( ::neash::events::MouseEvent FlashEvent);
		Dynamic handleMouseUp_dyn();

		virtual Void handleMouseDown( ::neash::events::MouseEvent FlashEvent);
		...
		int _lastY; /* REM */ 
		int _lastX; /* REM */ 
		::neash::display::Bitmap _cursor; /* REM */ 
		bool _updateCursorContainer; /* REM */ 
		::neash::display::Sprite _cursorContainer; /* REM */ 
		int _last; /* REM */ 
		int _current; /* REM */ 
		bool visible; /* REM */ 
		int screenY; /* REM */ 
