...
class FlxCamera_obj : public ::org::flixel::FlxBasic_obj{
	...
	public:
		...
		virtual Void fill( int Color,hx::Null< bool >  BlendAlpha,hx::Null< Float >  FxAlpha,::neash::display::Graphics graphics);
		Dynamic fill_dyn();

		virtual ::neash::display::Sprite getContainerSprite( );
		...
		Float green; /* REM */ 
		Float red; /* REM */ 
		::neash::display::Sprite _debugLayer; /* REM */ 
		::neash::display::Sprite _canvas; /* REM */ 
		::neash::display::BitmapData _fill; /* REM */ 
		...
		::neash::display::Sprite _flashSprite; /* REM */ 
