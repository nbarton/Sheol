...
class FlxSprite_obj : public ::org::flixel::FlxObject_obj{
	...
	public:
		...
		virtual Void updateLayerProps( );
		Dynamic updateLayerProps_dyn();
		...
		virtual ::neash::display::BitmapData setPixels( ::neash::display::BitmapData Pixels);
		Dynamic setPixels_dyn();

		virtual ::neash::display::BitmapData getPixels( );
		...
		::neash::geom::Point _flashPointZero; /* REM */ 
		::neash::geom::Rectangle _flashRect2; /* REM */ 
		::neash::geom::Rectangle _flashRect; /* REM */ 
		::neash::geom::Point _flashPoint; /* REM */ 
		...
		bool dirty; /* REM */ 
		::neash::display::BitmapData framePixels; /* REM */ 
		int frames; /* REM */ 
		int frameHeight; /* REM */ 
		int frameWidth; /* REM */ 
		bool paused; /* REM */ 
		...
		::String _blendString; /* REM */ 
		::neash::display::BlendMode _blend; /* REM */ 
