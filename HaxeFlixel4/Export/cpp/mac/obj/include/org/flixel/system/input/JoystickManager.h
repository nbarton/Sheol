...
class JoystickManager_obj : public hx::Object{
	...
	public:
		...
		virtual Void handleHatMove( ::neash::events::JoystickEvent FlashEvent);
		Dynamic handleHatMove_dyn();

		virtual Void handleBallMove( ::neash::events::JoystickEvent FlashEvent);
		Dynamic handleBallMove_dyn();

		virtual Void handleAxisMove( ::neash::events::JoystickEvent FlashEvent);
		Dynamic handleAxisMove_dyn();

		virtual Void handleButtonUp( ::neash::events::JoystickEvent FlashEvent);
		Dynamic handleButtonUp_dyn();

		virtual Void handleButtonDown( ::neash::events::JoystickEvent FlashEvent);
