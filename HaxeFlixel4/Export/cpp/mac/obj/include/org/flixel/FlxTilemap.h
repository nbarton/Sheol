...
class FlxTilemap_obj : public ::org::flixel::FlxObject_obj{
	...
	public:
		...
		::neash::geom::Point _helperPoint; /* REM */ 
		...
		::neash::display::BitmapData _tiles; /* REM */ 
		...
		static ::String bitmapToCSV( ::neash::display::BitmapData bitmapData,hx::Null< bool >  Invert,hx::Null< int >  Scale,Array< int > ColorMap);
