...
class FlxAssets_obj : public hx::Object{
	...
	public:
		...
		static ::String getNokiaFont( );
		static Dynamic getNokiaFont_dyn();

		static ::String courierFont; /* REM */ 
		static ::String getCourierFont( );
		static Dynamic getCourierFont_dyn();

		static ::String sndBeep; /* REM */ 
		static Void drawLogo( ::neash::display::Graphics graph);
