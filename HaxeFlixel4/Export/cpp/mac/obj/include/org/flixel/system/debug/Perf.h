...
class Perf_obj : public ::org::flixel::system::FlxWindow_obj{
	...
	public:
		static hx::ObjectPtr< Perf_obj > __new(::String Title,Float Width,Float Height,hx::Null< bool >  __o_Resizable,::neash::geom::Rectangle Bounds,Dynamic BGColor,Dynamic TopColor);
