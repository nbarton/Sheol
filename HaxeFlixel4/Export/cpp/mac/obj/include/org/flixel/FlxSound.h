...
class FlxSound_obj : public ::org::flixel::FlxBasic_obj{
	...
	public:
		...
		virtual Void gotID3( ::neash::events::Event event);
		Dynamic gotID3_dyn();

		virtual Void cleanup( bool destroySound,hx::Null< bool >  resetPosition);
		Dynamic cleanup_dyn();

		virtual Void stopped( ::neash::events::Event event);
		Dynamic stopped_dyn();
		...
		Float _position; /* REM */ 
		bool _paused; /* REM */ 
		::neash::media::SoundTransform _transform; /* REM */ 
		::neash::media::SoundChannel _channel; /* REM */ 
