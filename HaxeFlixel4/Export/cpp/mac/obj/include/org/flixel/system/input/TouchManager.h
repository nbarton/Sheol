...
class TouchManager_obj : public hx::Object{
	...
	public:
		...
		virtual Void handleTouchMove( ::neash::events::TouchEvent FlashEvent);
		Dynamic handleTouchMove_dyn();

		virtual Void handleTouchEnd( ::neash::events::TouchEvent FlashEvent);
		Dynamic handleTouchEnd_dyn();

		virtual Void handleTouchBegin( ::neash::events::TouchEvent FlashEvent);
